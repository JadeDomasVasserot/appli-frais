<?php
/**Controleur pour gérer l'Etat des frais d'un gestionnaire'
 * Un gestionnaire gère les actions de Saisir ses frais sur la fiche du mois en cours
...
include("vues/v_listeFraisForfaitGestionnaire.php");
include("vues/v_listeFraisHorsForfaitGestionnaire.php");
?>