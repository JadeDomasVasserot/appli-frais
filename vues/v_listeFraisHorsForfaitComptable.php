<!-- Affiche la liste des frais hors-forfait de la fiche du mois courant pour le comptable authentifié
...
<form action="index.php?uc=gererFraisComptable&action=validerCreationFrais" method="post">
  <div class="corpsForm">
    <fieldset>
