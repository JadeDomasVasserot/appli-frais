<?php
/**
 * Module permettant d'ajouter un frais hors forfait. Présent dans la Saisie fiche de frais du controleur gererFrais de 
 * visiteur, comptable et gestionnaire
 * Pour le module Saisir fiche de frais
 */
echo"
